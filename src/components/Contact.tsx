          ...
          <div className="relative grid lg:grid-cols-2 gap-12 sm:gap-20 lg:gap-32">
            ...
            <div>
              ...
              <TextReveal
                as="h2"
                delay={0.15}
                className="text-[clamp(1.75rem,5vw,4rem)] font-extralight tracking-tight text-white/85 leading-[1.15]"
              >
            ...
            <div className="flex flex-col justify-center">
              <div className="space-y-3 sm:space-y-4">
                <FadeIn delay={0.2} anim="slide-left" duration={0.7}>
                  <a
                ...
                <FadeIn delay={0.3} anim="slide-left" duration={0.7}>
                  <a
